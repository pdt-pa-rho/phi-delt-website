          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="https://www.cmu.edu/student-affairs/slice/greek/index.html" target="_blank" rel="noopener noreferrer" className="text-[var(--light-blue)] hover:text-[var(--white)]">CMU Greek Life</a></li>
