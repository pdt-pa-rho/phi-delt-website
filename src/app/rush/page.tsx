      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-6 md:p-24 pt-28">
        <div className="max-w-5xl w-full">
          ...
          <div className="mb-16 text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-(--white)">Rush Phi Delta Theta</h1>
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold mb-6 text-(--white)">Why Join Phi Delta Theta?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-(--light-blue) p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold mb-3 text-(--navy)">Lifelong Brotherhood</h3>
              ...
              <div className="bg-(--light-blue) p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold mb-3 text-(--navy)">Leadership Development</h3>
                <p className="text-(--navy)">
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold mb-6 text-(--white)">The Rush Process</h2>
            <div className="grid md:grid-cols-4 gap-6 text-center">
              <div className="bg-(--light-blue) p-6 rounded-lg shadow-md">
                <div className="w-12 h-12 bg-(--blue) rounded-full flex items-center justify-center mx-auto mb-4 text-(--white) font-bold text-xl">1</div>
                <h3 className="text-lg font-semibold mb-2 text-(--navy)">Attend Events</h3>
                <p className="text-(--navy)">
                  Come to our rush events to meet the brothers and learn about our chapter.
                </p>
              </div>
              <div className="bg-(--light-blue) p-6 rounded-lg shadow-md">
                <div className="w-12 h-12 bg-(--blue) rounded-full flex items-center justify-center mx-auto mb-4 text-(--white) font-bold text-xl">2</div>
                <h3 className="text-lg font-semibold mb-2 text-(--navy)">Receive a Bid</h3>
                <p className="text-(--navy)">
                  If there&apos;s mutual interest, you&apos;ll receive a bid to join our chapter.
                </p>
              </div>
              <div className="bg-(--light-blue) p-6 rounded-lg shadow-md">
                <div className="w-12 h-12 bg-(--blue) rounded-full flex items-center justify-center mx-auto mb-4 text-(--white) font-bold text-xl">3</div>
                <h3 className="text-lg font-semibold mb-2 text-(--navy)">New Member Education</h3>
                <p className="text-(--navy)">
                  Learn about our history, values, and brotherhood through our Phikeia program.
                </p>
              </div>
              <div className="bg-(--light-blue) p-6 rounded-lg shadow-md">
                <div className="w-12 h-12 bg-(--blue) rounded-full flex items-center justify-center mx-auto mb-4 text-(--white) font-bold text-xl">4</div>
                <h3 className="text-lg font-semibold mb-2 text-(--navy)">Initiation</h3>
                <p className="text-(--navy)">
          ...
          {/* <section className="mb-16">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold mb-2 text-(--white)">What is the time commitment?</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-(--white)">What are the costs associated with membership?</h3>
                <p className="text-(--white)/80">
          ...
          <section className="text-center bg-(--blue) p-8 rounded-lg">
            <h2 className="text-3xl font-bold mb-4 text-(--white)">Interested in Rushing?</h2>
