  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-6 md:p-24 bg-(--navy)">
      <div className="max-w-5xl w-full">
        ...
        {/* Donate via Zelle */}
        <section className="mb-16 bg-(--light-blue) p-8 md:p-12 rounded-lg shadow-md text-center">
          <h2 className="text-3xl font-bold mb-4 text-(--navy)">
            Donate via Zelle
          </h2>
          <p className="text-(--navy) mb-6 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-6">
            ...
            <div className="flex flex-col items-center">
              <div className="bg-(--navy) text-(--white) px-8 py-4 rounded-lg">
                <p className="text-sm uppercase tracking-wider mb-1 text-(--white)/60">
                  Zelle Phone Number
                </p>
              ...
              <p className="text-(--navy)/70 text-sm max-w-xs mt-4 text-center">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-(--light-blue) p-6 rounded-lg shadow-md text-center">
              <div className="text-4xl font-bold text-(--blue) mb-3">1</div>
            ...
            <div className="bg-(--light-blue) p-6 rounded-lg shadow-md text-center">
              <div className="text-4xl font-bold text-(--blue) mb-3">2</div>
              <h3 className="text-xl font-semibold mb-2 text-(--navy)">
                Send to Our Number
              </h3>
              <p className="text-(--navy)">
            ...
            <div className="bg-(--light-blue) p-6 rounded-lg shadow-md text-center">
              <div className="text-4xl font-bold text-(--blue) mb-3">3</div>
              <h3 className="text-xl font-semibold mb-2 text-(--navy)">
                Add Your Name
              </h3>
              <p className="text-(--navy)">
